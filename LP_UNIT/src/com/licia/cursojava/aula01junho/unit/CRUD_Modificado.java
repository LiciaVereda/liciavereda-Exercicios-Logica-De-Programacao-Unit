...
public class CRUD_Modificado {
	...
	public static void main(String[] args) {
		...
		do {
			...
			if(opcao < 0 || opcao > 8) {
				System.out.println(" **** Digite uma das opções disponíveis no menu. **** ");
				continue;
			}
			...
			case 5:
				...
				if (arrayExiste == true) {
					...
					if(dado!=0) {
						...
						for (int i = 0; i < array.length; i++) {   //Reorganiza o vetor para que as últimas posições sejam 0.
	...
	private static void merge(float[] array,int ini, int meio, int fim) {
	        ...
	        //índice do subvetor auxiliar esquerdo
	        int idxEsq = 0; 
	        
	        //índice do subvetor auxiliar direito
	        int idxDir = 0; 
